...
#+Time-stamp: <2021-06-16 19:52:39 boxx>
...
*(!)* All the ~def~ forms define globale objects *(!)*. It is also possible to define local variables with ~let~, and to define local functions with ~labels~, as we shall see.
